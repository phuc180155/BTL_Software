...
public interface InterbankInterface {
	 ...
	 * @return {@link entity.Transaction Transaction} - if the
	 ...
	 */
	public abstract Transaction payOrder(CreditCard card, int amount, String contents)
	 ...
	 *                               something goes wrong
	 */
	public abstract Transaction refund(CreditCard card, int amount, String contents)
			throws PaymentException, UnrecognizedException;
